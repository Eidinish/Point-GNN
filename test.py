"""This file defines the unit tests of Point-GNN object detection."""
...
parser.add_argument('--train_config_path', type=str, default='configs/car_auto_T3_train_train_config',
                   help='Path to train_config')
parser.add_argument('--config_path', type=str, default='configs/car_auto_T3_train_config',
                   help='Path to config')
